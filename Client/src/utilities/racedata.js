const raceData = {
    ...
    "Octubian": {
      raceDescription: "A race of octopus-like humanoids known for their ability to swim and their ink cloud ability",
      racialBonus: "Intelligence +2",
      racialAbility: "Ink Cloud - Focus Ability",
      racialNegative: "Strength -2",
      hpBonus: "+6",
      startingJinx: "40",
      startingLevel: "5",
    ...
    "Dawsp": {
      raceDescription: "A race of large carvivorous Wasps who gained sentience by a dark spell.  They are rarely seen in civilized society as they have very poor impulse control.",
      racialBonus: "Reflex +3",
      racialAbility: "Telekenisis - lbs x Level",
      racialNegative: "Charisma -5",
      hpBonus: "+5",
      startingJinx: "40",
      startingLevel: "2",
    ...
    "Boon": {
      raceDescription: "A race of baboon-like humanoids known for their agility and their ability to climb trees",
      racialBonus: "Reflex +2",
      racialAbility: "Acrobatics - Focus Ability",
      racialNegative: "Intelligence -2",
      hpBonus: "+5",
      startingJinx: "25",
      startingLevel: "2",
    ...
    "Trinon": {
      raceDescription: "A race of sliver-skinned humanoids with large floating golden circles around their heads.  They are hybrid humans and aliens from the last remaining world Regynn",
      racialBonus: "Charisma +2",
      racialAbility: "Double Down - Focus Ability",
      racialNegative: "Intelligence -2",
      hpBonus: "+8",
      startingJinx: "25",
      startingLevel: "2",
    ...
    "Shifter": {
      raceDescription: "A race of fungi-like humanoids who are able to change their physical appearance and the sound of their voice at will",
      racialBonus: "Fortitude +3",
      racialAbility: "Shapeshift - Can shift face to look like somone else for up to 1 hour",
      racialNegative: "Strength -2",
      hpBonus: "+6",
      startingJinx: "25",
      startingLevel: "2",
    ...
    "Thyst": {
      raceDescription: "A race of crystalline humanoids known for their ability to telepathic abilities and their crystalline skin",
      racialBonus: "Fortitude +3",
      racialAbility: "Telepathy",
      racialNegative: "Reflex -2",
      hpBonus: "+9",
    ...
    "Wereman": {
      raceDescription: "A race of werewolf-like humanoids known for their strength and their abilit to retain their mind while in wolf form.",
      racialBonus: "Strength +2",
      racialAbility: "Wolf Form - Can turn into a wolf at will (not a werewolf)",
      racialNegative: "Charisma -1",
      hpBonus: "+7",
      startingJinx: "30",
      startingLevel: "4",
    ...
    "Ivotien": {
      raceDescription: "A race of ivory skinned humanoids that are known for their ability to percieve time differently and their ivory skin",
      racialBonus: "Charisma +2",
      racialAbility: "Additional Focus Power",
      racialNegative: "Intelligence -1",
      hpBonus: "+8",
      startingJinx: "35",
      startingLevel: "4",
    ...
    "Mannenite": {
      raceDescription: "A race of lion-like humanoids known for their strength and their skills at jungle worfare",
      racialBonus: "Strength +2",
      racialAbility: "Lionclaw - Scratch target for D8 damage each",
      racialNegative: "Reflex -2",
      hpBonus: "+8",
      startingJinx: "35",
      startingLevel: "4",
    ...
    "Oakrels": {
      raceDescription: "A race of frog-like humanoids infamous for the Great Betrayal and their magic abilities",
      racialBonus: "Intelligence +2",
      racialAbility: "Bubble - Can create a bubble of air to breath underwater for 1 hour at a time",
      racialNegative: "Reflex -1",
      hpBonus: "+6",
      startingJinx: "30",
      startingLevel: "3",
    ...
    "Felynx": {
      raceDescription: "A race of cheetah-like humanoids known for their speed and their ability to run great distances",
      racialBonus: "Reflex +1",
      racialAbility: "Acrobatics - Focus Ability",
      racialNegative: "Intelligence -1",
      hpBonus: "+6",
    ...
    "Treeton": {
      raceDescription: "A race of tree-like humanoids known for their strength and their ability to re-grow limbs",
      racialBonus: "Fortitude +2",
      racialAbility: "Rooted - Become a tree for a short rest",
      racialNegative: "Charisma -1",
      hpBonus: "+7",
      startingJinx: "30",
      startingLevel: "3",
    ...
    "Goblin": {
      raceDescription: "A race of goblin creatures known for their cunning and their ability to scavenge",
      racialBonus: "Reflex +3",
      racialAbility: "Scavenger - Can find specific item(s) in the environment once per session",
      racialNegative: "Charisma -1",
      hpBonus: "+6",
      startingJinx: "35",
      startingLevel: "4",
    ...
    "Blood Elf": {
      raceDescription: "A race of elves with demonic blood known for their beauty and their ability to blood rituals",
      racialBonus: "Reflex +1",
      racialAbility: "Vampiric Healing - Able to drink blood to restore 1 D6 hp per pint",
      racialNegative: "Fortitude -1",
      hpBonus: "+6",
      startingJinx: "35",
      startingLevel: "4",
    ...
    "Cuth": {
      raceDescription: "A race of aliens trapped on this planet after their ship crashed.  They are known for their ability to speak any language and their strange appearance",
      racialBonus: "Intelligence +1",
      racialAbility: "Allies Influence - Focus Ability",
      racialNegative: "Strength -1",
      hpBonus: "+6",
      startingJinx: "40",
      startingLevel: "5",
    ...
    "Magelv": {
      raceDescription: "A race of magma focused Elvenkind known for their flaming hair and their cruelty",
      racialBonus: "Fortitude +2",
      racialAbility: "Pyrokinetic Strike - Focus Ability",
      racialNegative: "Strength -3",
      hpBonus: "+7",
      startingJinx: "35",
      startingLevel: "4",
    ...
    "Bisanu": {
      raceDescription: "A race of Anubis like humanoids known for their desert survival skills and their polyamorous nature",
      racialBonus: "Intelligence +2",
      racialAbility: "Bonus Unfocused Ability",
      racialNegative: "Charisma -1",
      hpBonus: "+7",
      startingJinx: "25",
      startingLevel: "2",
    ...
    "Potec": {
      raceDescription: "A race of bird like humanoids with the heads of parrots.  They are known for their ignornace and their love of song",
      racialBonus: "Fortitude +1",
      racialAbility: "Flight - Focus Ability",
      racialNegative: "Intelligence -2",
      hpBonus: "+7",
    ...
    "Banda": {
      raceDescription: "A race of panda-like humanoids known for their sense of honor and their skill with bamboo wood",
      racialBonus: "Strength +1",
      racialAbility: "Ninja Step - No sound while moving while engaged",
      racialNegative: "Charisma -1",
      hpBonus: "+8",
      startingJinx: "30",
      startingLevel: "3",
    ...
    "Cossakus": {
      raceDescription: "A race of centaur-pegasus like statues that were magically brought to life.  The human portion is genderswapped with a standard horse body and two wings all made from stone",
      racialBonus: "Strength +1",
      racialAbility: "Flight - Focus Ability",
      racialNegative: "Reflex -2",
      hpBonus: "+7",
